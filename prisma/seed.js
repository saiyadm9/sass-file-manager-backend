...
async function main() {
    ...
    const [adminHash, userHash] = await Promise.all([
        bcrypt_1.default.hash(ADMIN_PASSWORD, 10),
        bcrypt_1.default.hash(DEMO_USER_PASSWORD, 10)
    ]);
    // ====== Seed Admin ======
    ...
    const packages = [
        {
            ...
            maxFolders: 10,
            maxNestingLevel: 2,
            allowedTypes: [client_1.FileType.IMAGE, client_1.FileType.PDF],
            maxFileSizeMB: 5,
            totalFileLimit: 20,
            filesPerFolder: 5
        },
        {
            ...
            maxFolders: 50,
            maxNestingLevel: 4,
            allowedTypes: [client_1.FileType.IMAGE, client_1.FileType.PDF, client_1.FileType.AUDIO],
            maxFileSizeMB: 25,
            totalFileLimit: 200,
            filesPerFolder: 25
        },
        {
            ...
            maxFolders: 200,
            maxNestingLevel: 6,
            allowedTypes: [client_1.FileType.IMAGE, client_1.FileType.PDF, client_1.FileType.AUDIO, client_1.FileType.VIDEO],
            maxFileSizeMB: 100,
            totalFileLimit: 1000,
            filesPerFolder: 100
        },
    ...
    if (!freePkg)
        throw new Error("Free package not found after seeding.");
    // ====== Seed Demo User ======
